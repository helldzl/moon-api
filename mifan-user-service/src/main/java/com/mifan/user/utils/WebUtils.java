 ...
 *
 * @className:com.mifan.user.utils.WebUtils
 *
 * @description:TODO
 *
 * @version:v0.0.1
...
public class WebUtils {
    ...
    public static String doPost(String url, String apiBody, String charset, int connectTimeout, int readTimeout, Map<String, String> headerMap,Proxy proxy) throws IOException {
