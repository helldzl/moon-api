...
@Api(description = "前台接口-奖项信息-prizes相关API", basePath = "/prizes")
@RestController
@RequestMapping("/prizes")
public class PrizesController extends RestfulController<Prizes> {

    @ApiOperation(value = "根据id获取指定奖项信息")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "分页获取奖项信息", notes = "添加筛选条件和排序字段 filter[enabled]=1&filter[prizeId]=1&filter[userId]")
    @ApiImplicitParams({
