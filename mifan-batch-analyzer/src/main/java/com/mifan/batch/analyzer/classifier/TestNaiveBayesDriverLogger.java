 ...
 */
public class TestNaiveBayesDriverLogger extends AbstractJob {

    private static final Log logger = LogFactory.getLog(org.apache.mahout.classifier.naivebayes.test.TestNaiveBayesDriver.class);
    private static final String COMPLEMENTARY = "class"; //b for bayes, c for complementary
    private static final Pattern SLASH = Pattern.compile("/");

    private String result;

    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(), new TestNaiveBayesDriverLogger(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        String result = String.format("%s Results: %s", hasOption("testComplementary") ? "Complementary" : "Standard NB", analyzer);
        logger.info(result);
        setResult(result);
        return 0;
    }
