...
public class Users extends BaseEntity {
    ...
    @OneToMany(value = "groups",
            targetEntity = UsersGroups.class,
            mappedBy = UsersGroups.USER_ID,
            mappedTo = UsersGroups.GROUP_ID)
    @OneToMany(value = "roles",
            targetEntity = UsersRoles.class,
            mappedBy = UsersRoles.USER_ID,
            mappedTo = UsersRoles.ROLE_ID)
    private Long id;
    ...
    @Valid
    private UserAccounts userAccount; // 账户
