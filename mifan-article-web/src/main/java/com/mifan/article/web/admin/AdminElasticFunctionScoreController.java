 ...
 */
@RestController
@RequestMapping("/admin/Efss")
public class AdminElasticFunctionScoreController extends RestfulController<ElasticFunctionScore> {
    ...
    public ResponseEntity<Response> doPost(
            @RequestBody Data<ElasticFunctionScore> data){
