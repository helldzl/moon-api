...
@RestController
@RequestMapping("/admin/WordDictionary")
public class AdminWordDictionaryController extends RestfulController<WordDictionary> {
    ...
    public ResponseEntity<Response> doPost(
            @RequestBody Data<WordDictionary> data) {
